...
current_light_color = {'r': 255, 'g': 255,
                       'b': 255, 'brightness': 80}  # 現在のライト色
...
while True:
    try:
        ret, frame = cap.read()
        if not ret:
            print("ストリームが切れました。not by keyboard interrupt.")
            break
                ...
                for face in face_results:
                    ...
                    if current_time - session_start_time >= DB_SAVE_INTERVAL:
                        ...
                        try:
                            ...
                            session_id = save_session_to_db(
                                name, session_data, current_light_color)
                    ...
                    if not ai_is_running and can_trigger_ai:
                        ...
                        try:
                            ...
                            print(
                                f"--- AI起動成功。ログは {ai_logfile_path} を確認 ---")
                        except Exception as e:
                    ...
                    if concentration_str and concentration_str != "Unknown":
                        try:
                            ...
                            update_concentration(
                                current_session_id, concentration_data)
        ...
        print("ストリームが切れました。Keyboard interrupt.")
